...
def main(args=None):
    ...
    parser.add_argument('--optimizer', help='Path to optimizer.')
    ...
    sampler = AspectRatioBasedSampler(dataset_train, batch_size=3, drop_last=False, shuffle=True)
    ...
    optimizer = torch.load(parser.optimizer)
